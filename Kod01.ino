...
void vykresliGraf(){
  ...
  while(oled_1.nextPage()){
    ...
    for(int i = 0; i < maxMesicu; i++){
      ...
      int cisloMesice = (datumCas.month - (maxMesicu - 1 - i) + 12) % 12;
    ...
    switch(aktualniRezim){
      ...
      case 6: vykresliOzubene(); 
              ...
              switch(rezimZalevani){
                ...
                case 1: vykresliOdpocet(); /*musi cekat na stisk klavesy*/ break;
                //case 2: vykresliPravidelne(); break;
              }
              break; 
      case 7: vykresliStatistika(); 
              if(klavesa == 'A'){
                rezimStatistika--;
